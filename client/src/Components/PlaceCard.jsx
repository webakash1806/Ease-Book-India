...
const PlaceCard = () => {
    return (
        <div className='bg-white text-black w-[92vw] max-w-[24rem] rounded-xl overflow-hidden hover:from-[#d0f7e6] hover:bg-gradient-to-b shadow-[0px_0px_8px_#808080] hover:to-[#f7fffb]'>
