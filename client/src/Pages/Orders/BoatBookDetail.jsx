...
const BoatBookDetail = () => {
    ...
    const breadcrumbItems = [
        { label: 'Home', href: '/' },
        { label: 'Boat Bookings Detail', },
    ];

    return (
        <>
            <div className='relative'>
                <SocialCard item={breadcrumbItems} icon={"boat"} title={"Booking Details"} des={`This is your Boat booking detail which was booked on ${orderDate} at ${orderTime}.`} />
