...
const HotelBookDetail = () => {
    ...
    const breadcrumbItems = [
        { label: 'Home', href: '/' },
        { label: 'Hotel Bookings Detail', },
    ];

    return (
        <>
            <div className='relative'>
                <SocialCard item={breadcrumbItems} icon={"h"} title={"Booking Details"} des={`This is your Hotel booking detail which was booked on ${bookDetail?.orderDate} at ${bookDetail?.orderTime}.`} />
