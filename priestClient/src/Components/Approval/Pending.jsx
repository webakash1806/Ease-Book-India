        ...
        <div className='bg-[#fff] shadow-[0px_0px_20px_#C9C9CB] w-fit rounded-md relative overflow-hidden text-black flex flex-col md:flex-row items-end md:gap-10'>
            ...
            {lang === 'en' ?
                <div className='relative flex flex-col gap-2 md:p-10 sm:p-8 p-4 pt-8  md:w-[50vw]'>
                    ...
                    <p>Thank you for registering as a Pandit ji with us. We are excited to have you on board and look forward to working together to provide the best service possible.</p>
                ...
                <div className='relative flex flex-col gap-3 md:p-10 sm:p-8 p-4 pt-8 text-[0.95rem] md:w-[50vw]' >
                    ...
                    <p>हमारे साथ पंडित जी के रूप में पंजीकरण करने के लिए धन्यवाद। हम आपको अपने साथ जोड़कर उत्साहित हैं और सर्वश्रेष्ठ सेवा प्रदान करने के लिए एक साथ काम करने की आशा करते हैं।</p>
                    <div>
