        ...
        <div className='min-h-[90vh] min-w-full flex items-start justify-center bg-[#f8f6fc]'>
            <div className='shadow-[0px_0px_20px_#3D4056] flex items-center justify-center gap-4 mt-12 bg-[#2F3349] text-white  rounded-lg w-fit'>
                ...
                <form noValidate onSubmit={handleFormInput} className='flex flex-col items-start justify-center gap-2 p-4 py-8'>
                    ...
                    <button onClick={() => setLoaderActive(true)} type='submit' className='w-full mt-2 mb-4 bg-[#685ED4] hover:bg-[#FF4C51] transition-all duration-700 font-semibold rounded overflow-hidden text-white p-2 flex items-center justify-center'>Login {loaderActive && <div className='ml-4 ease-in-out mt-1 size-[1.25rem] border-[2.4px] border-t-[#46454546] animate-spin rounded-full bottom-0 '></div>} </button>
