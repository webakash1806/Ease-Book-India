...
import { getCarBookings, getGuiderBookings, getPriestBookings } from '../../Redux/Slices/ListSlice';
...
const GuiderOrders = () => {
    ...
    const orderData = useSelector((state) => state?.list?.guiderBooking) || [];

    const loadData = async () => {
        setLoading(true);
        await dispatch(getGuiderBookings());
        setLoading(false);
    };
