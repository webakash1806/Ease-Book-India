...
import { getDriverList, getGuiderList, getHotelList, getPriestList, updateDriverStatus, updateGuiderStatus, updateHotelStatus, updatePriestStatus } from '../../Redux/Slices/ListSlice';
...
const HotelsList = () => {
    ...
    const loadData = async () => {
        setLoading(true);
        try {
            await dispatch(getHotelList()).unwrap();
        } catch (error) {
