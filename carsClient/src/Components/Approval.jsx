...
const Approval = () => {
    ...
    return (
        <div className='bg-[#fff] shadow-[0px_0px_20px_#C9C9CB] w-fit rounded-md relative overflow-hidden text-black flex flex-col md:flex-row items-end md:gap-10'>
            ...
            {lang === 'en' ?
                <div className='relative flex flex-col gap-2 p-8 md:w-[50vw]'>
                    ...
                    <div className="pending-info">
                        <p>Your registration is currently <strong>PENDING</strong> for verification.</p>
                ...
                <div className='relative flex flex-col gap-3 p-8 text-[0.95rem] md:w-[50vw]' >
                    <h2>Welcome {fullName}!🙏</h2>
                    ...
                    <div>
                        <p>आपका पंजीकरण वर्तमान में <strong>लंबित</strong> सत्यापन में है।</p>
